...
mapdata <- read.table(paste0("results/6_Linkage_Map_Positions_CEL_run5_a", AnalysisSuffix, ".txt"),
                      header = T, stringsAsFactors = F)
...
save(famped, mapdata, skel.map, abeldata, AnalysisSuffix, pseudoautoSNPs,
     AnalysisSuffix2, AnalysisSuffix3, lg.vec, file = "flipstest/6_run5_Deer_Data_for_Eddie_a.RData")
